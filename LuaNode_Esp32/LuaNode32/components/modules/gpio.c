...
// gpio.serout(1,1,{0,0},8)  -- serial 50% pwm as fast as possible, lasts 8
// cycles gpio.mode(1,gpio.OUTPUT,gpio.PULLUP)
// gpio.serout(1,0,{20,10,10,20,10,10,10,100}) -- sim uart one byte 0x5A at
// about 100kbps gpio.serout(1,1,{8,18},8) -- serial 30% pwm 38k, lasts 8 cycles
...
// Module function map
const LUA_REG_TYPE gpio_map[] = {{LSTRKEY("mode"), LFUNCVAL(lgpio_mode)},
