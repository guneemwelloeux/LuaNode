...
static const Charset fullset_ = { { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
tailcall:
    ...
    case TCall:
        tree = sib2(tree);
        goto tailcall; /* return hascaptures(sib2(tree)); */
    case TOpenCall:
        assert(0);
    default:
    {
...
tailcall:
    ...
    case TRunTime: /* can fail; match empty iff body does */
        ...
        goto tailcall;
    case TSeq:
        if (!checkaux(sib1(tree), pred))
            return 0;
        /* else return checkaux(sib2(tree), pred); */
        tree = sib2(tree);
        goto tailcall;
    case TChoice:
        if (checkaux(sib2(tree), pred))
            return 1;
        /* else return checkaux(sib1(tree), pred); */
        tree = sib1(tree);
        goto tailcall;
