...
const uint32_t GPIO_PIN_MUX_REG[GPIO_PIN_COUNT] = {GPIO_PIN_REG_0,
                                                   GPIO_PIN_REG_1,
                                                   GPIO_PIN_REG_2,
                                                   GPIO_PIN_REG_3,
                                                   GPIO_PIN_REG_4,
...
/*esp_err_t gpio_isr_register(uint32_t gpio_intr_num, void (*fn)(void*), void *
arg)
{
    if(fn == NULL) {
        return ESP_ERR_INVALID_ARG;
...
esp_err_t gpio_wakeup_enable(gpio_num_t gpio_num, gpio_int_type_t intr_type)
{
    ...
    {
        GPIO_ERROR(
            "GPIO wakeup only support Level mode,but edge mode set. "
            "gpio_num:%u\n",
            gpio_num);
        ret = ESP_ERR_INVALID_ARG;
    }
