        ...
        if (!param->write.is_prep)
        {
            ...
            if (gl_profile_tab[PROFILE_A_APP_ID].descr_handle == param->write.handle && param->write.len == 2)
            {
                ...
                if (value == 0x0001)
                {
                    ...
                    esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, gl_profile_tab[PROFILE_A_APP_ID].char_handle, sizeof(value), value, false);
                }
        ...
        if (!param->write.is_prep)
        {
            ...
            if (gl_profile_tab[PROFILE_B_APP_ID].descr_handle == param->write.handle && param->write.len == 2)
            {
                ...
                if (value == 0x0001)
                {
                    ...
                    //the size of value[] need less than MTU size
                    esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, gl_profile_tab[PROFILE_B_APP_ID].char_handle, sizeof(value), value, false);
                }
                else if (value == 0x0000)
                {
                    ESP_LOGI(GATTS_TAG, "notify disable ");
