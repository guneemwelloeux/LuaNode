...
static const char device_name[] = "ESP_GATTS_DEMO";
...
static struct gattc_profile_inst gl_profile_tab[PROFILE_NUM] = {
    [PROFILE_A_APP_ID] =
        {
            .gattc_cb = gattc_profile_event_handler, .gattc_if = ESP_GATT_IF_NONE, /* Not get the gatt_if, so initial is
                                                                                      ESP_GATT_IF_NONE */
        },
};
                                        ...
                                        esp_ble_gattc_cb_param_t *param)
{
    ...
    switch (event)
    {
        ...
        case ESP_GATTC_OPEN_EVT:
            ...
            ESP_LOGI(GATTC_TAG, "ESP_GATTC_OPEN_EVT conn_id %d, if %d, status %d, mtu %d", conn_id, gattc_if,
        ...
        case ESP_GATTC_SEARCH_RES_EVT:
        {
            ...
            else if (srvc_id->id.uuid.len == ESP_UUID_LEN_128)
            {
                ...
                // esp_log_buffer_hex(GATTC_TAG, srvc_id->id.uuid.uuid.uuid128,
                // ESP_UUID_LEN_128);
            }
            else
            {
        ...
        case ESP_GATTC_REG_FOR_NOTIFY_EVT:
        {
            ...
            esp_ble_gattc_write_char_descr(gattc_if, conn_id, &alert_service_id, &p_data->reg_for_notify.char_id,
        ...
        case ESP_GATTC_NOTIFY_EVT:
            ...
            // p_data->notify.value_len); write  back
            esp_ble_gattc_write_char(gattc_if, gl_profile_tab[PROFILE_A_APP_ID].conn_id, &alert_service_id,
                                     &p_data->notify.char_id, p_data->notify.value_len, p_data->notify.value,
                                     ESP_GATT_WRITE_TYPE_RSP, ESP_GATT_AUTH_REQ_NONE);
            break;
        case ESP_GATTC_WRITE_DESCR_EVT:
            ESP_LOGI(GATTC_TAG, "WRITE DESCR: status %d", p_data->write.status);
            break;
        ...
        /*case ESP_GATTC_DISCONNECT_EVT:
           ...
           p_data->disconnect.status); break;*/
        default:
            break;
    }
}
        ...
        case ESP_GAP_BLE_SCAN_RESULT_EVT:
        {
            ...
            switch (scan_result->scan_rst.search_evt)
            {
                case ESP_GAP_SEARCH_INQ_RES_EVT:
                    // esp_log_buffer_hex(GATTC_TAG, scan_result->scan_rst.bda,
                    // 6);
...
void app_main()
{
    ...
    {
        // ESP_ERROR_CHECK(nvs_flash_erase());  //nvs_erase_all
        ret = nvs_flash_init();
    }
    ESP_ERROR_CHECK(ret);
